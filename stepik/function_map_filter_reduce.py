...
print(reduce(lambda a, b: a + b ** 2, numbers, 0))  # вывод суммы квадратов элементов списка numbers

print(sum(list(map(lambda x: x ** 2, numbers))))  # вывод суммы квадратов элементов списка numbers

print(list(filter(lambda x: x > 90, numbers))) # филтр элементов списка numbers>90
